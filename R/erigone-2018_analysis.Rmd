...
ggplot(data = patches_updated) +
    inset_ggmap(map_background) + # add ggmap background
    geom_sf(aes(fill = `patch type`),col=NA) + 
    scale_fill_manual(values=c("#00cf3a","#afdab2","#e3e0df"))+
