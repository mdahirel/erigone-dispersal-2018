...
<!-- a lot of code here assumes you've run the main code, and in particular that all objects saved while running the main code exist in the relevant folder-->
...
newdata_pop<-tibble(landscape=factor(c("west","east"),
                                     levels=c("west","east")),
...
plot2<-ggplot()+
  ...
  geom_jitter(data=sites,aes(landscape,N_adult_females/person_hours_on_patch),
